...
public class AlphaController {
    ...
    @ResponseBody
    //这个方法能够被浏览器访问到的前提是，也要有注解，注解里面的“”是访问路径，相当于/alpha/Hello路径
    //第二个注解说明了return 的是字符串
    ...
    public void http(HttpServletRequest request, HttpServletResponse response){
        ...
        System.out.println(request.getParameter("cade"));
    ...
    public String getSchool(Model model){
       model.addAttribute("name","BUPT");
        model.addAttribute("age","1111111");
        return "/demo/view";
    }

    //相应JSON数据（异步请求）
    //JAVA对象 -> JSON 字符串 ->返回给浏览器  JS语言解析对象
